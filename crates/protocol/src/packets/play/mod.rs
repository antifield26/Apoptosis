...
pub use self::inventory::{
    ...
    MAX_CONTAINER_SLOTS, MAX_ITEM_COMPONENTS, MAX_METADATA_ENTRIES, MENU_FURNACE, MENU_GENERIC_3X3,
    MENU_GENERIC_9X3, MENU_GENERIC_9X6, MENU_HOPPER, METADATA_INDEX_CREEPER_FUSE,
