...
the Phase 03 report (git history, tag `phase-09-final`). No Mojang binary, jar, asset or datapack is
committed.
...
(`tools/vanilla-probe/DumpRegistries.java` boots the jar's own registry;
