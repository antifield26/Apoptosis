...
Totals: **1 445 passed, 0 failed, 34 ignored** across **113 suites**, re-derived from
...
1 365 -> 1 380 -> 1 384 -> 1 386 -> 1 388 -> 1 389 -> 1 392 -> 1 399 -> 1 412 -> 1 426 -> 1 428 -> 1 431 -> 1 433 -> 1 437 -> 1 440 -> 1 441 -> **1 445**: three from the Audit 07 remediation, two Audit 08 coverage tests, ten from the
...
26 -> 27), and rejoin restoring the leave state (`reconnect` 2 -> 3).
...
while updating this total. The 17 lib counts sum to **1 040** (`mc-protocol` 113 ->
...
the **400** named-suite tests complete the 1 445 (1 040 + 5 + 400 = 1 445, the third
