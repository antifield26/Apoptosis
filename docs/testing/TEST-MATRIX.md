...
Totals: **1 389 passed, 0 failed, 34 ignored** across **109 suites**, re-derived from
...
1 365 -> 1 380 -> 1 384 -> 1 386 -> 1 388 -> **1 389**: three from the Audit 07 remediation, two Audit 08 coverage tests, ten from the
...
(`survival_e2e`). The 34 ignored = the 8 differential
...
the **355** named-suite tests complete the 1 389 (1 029 + 5 + 355 = 1 389, the third
