...
Totals: **1 587 passed, 0 failed, 35 ignored** across **126 suites**, re-derived from
...
gap-routing plus the reworked no-phasing wall test (Step A), and five
