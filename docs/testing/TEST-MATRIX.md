...
Totals: **1 475 passed, 0 failed, 34 ignored** across **115 suites**, re-derived from
...
1 365 -> 1 380 -> 1 384 -> 1 386 -> 1 388 -> 1 389 -> 1 392 -> 1 399 -> 1 412 -> 1 426 -> 1 428 -> 1 431 -> 1 433 -> 1 437 -> 1 440 -> 1 441 -> 1 445 -> 1 451 -> 1 452 -> 1 468 -> **1 475**: three from the Audit 07 remediation, two Audit 08 coverage tests, ten from the
...
subprocess tests, the capture sweep, and the cow sound-variant golden.
