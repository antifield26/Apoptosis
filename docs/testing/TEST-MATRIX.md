...
Totals: **1 399 passed, 0 failed, 34 ignored** across **109 suites**, re-derived from
`cargo test --workspace --no-fail-fast` on the P13-06 tree (`python
tools/gates/run.py --quick`: every gate passed). The count has
moved 1 194 -> 1 196 -> 1 206 -> 1 207 -> 1 212 -> 1 325 -> 1 344 -> 1 346 -> 1 358 ->
1 365 -> 1 380 -> 1 384 -> 1 386 -> 1 388 -> 1 389 -> 1 392 -> **1 399**: three from the Audit 07 remediation, two Audit 08 coverage tests, ten from the
...
geometry in the same pass. The 34 ignored = the 8 differential
...
the **363** named-suite tests complete the 1 399 (1 031 + 5 + 363 = 1 399, the third
