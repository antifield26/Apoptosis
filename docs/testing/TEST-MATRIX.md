...
item-only recipes convert, sticks present). Current inventory: **8 suites /
16 ignored tests** (the 7 + `vanilla_crafting`). `vanilla_pack` counts are
**1 454 recipes / 61 unmodelled** since P17-03 (was 1 421 / 94).
